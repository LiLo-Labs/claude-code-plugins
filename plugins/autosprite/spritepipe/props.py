...
def _library():
    ...
    ripple = Animation(
        ...
        note="a broad face that has no joint to hinge about -- water, a banner, "
             ...
             "touches 21.4%; leaning the same cloth rigidly with `shear` "
             "instead gets 68.2%, and adding a lean ON TOP of the wave gets "
             "63.6% while moving more than twice as many pixels -- so cloth is "
